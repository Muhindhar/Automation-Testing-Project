...
public class PrescriptionPage {
    ...
    public final By headerNoteLabel = By.xpath("//label[normalize-space()='Header Note']");
    ...
    public final By medicineOptions          = By.cssSelector("select[name='medicine_1'] option");
    public final By doseDropdown             = By.cssSelector("select[name='dosage_1']");
    public final By doseOptions              = By.cssSelector("select[name='dosage_1'] option");
    ...
    public final By saveButton               = By.xpath("//button[@name='save_print']/following-sibling::button");
    ...
    public final By viewPrescription = By.xpath("//table[@id='DataTables_Table_2']//tbody/tr[1]/td//a[contains(@href,'prescription')]");
    ...
    public final By confirmDeleteBtn         = By.xpath(
            ...
            "//button[contains(text(),'delete')] | //button[contains(@class,'swal-button--confirm')] | " +
            "//button[contains(@class,'confirm')]");
    public final By deleteSuccessMessage     = By.xpath(
