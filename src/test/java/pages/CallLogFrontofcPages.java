...
public class CallLogFrontofcPages {
	...
	public By incom = By.xpath(
			"//form[@id='formadd']//label[@class='radio-inline'][normalize-space()='Incoming']//input[@name='call_type']");
	public By outgng = By.xpath(
			"//form[@id='formadd']//label[@class='radio-inline'][normalize-space()='Outgoing']//input[@name='call_type']");
	public By savebtn = By.xpath("//button[@id='formaddbtn']");
	public By checklist = By.xpath("//h3[@class='box-title titlefix']");
	public By error = By.xpath("//*[contains(text(),'required')]");
}
