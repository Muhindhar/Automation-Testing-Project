...
public class EditDeletePrescriptionStepDefinition {
    ...
    private static final String IPD_NUMBER = ConfigReader.getProperty("IPDno");
    ...
    public void updates_the_prescription_details() {
        HelperClass.logger.info("Updating prescription details for IPD: {}",IPD_NUMBER);
    ...
    public void a_confirmation_popup_should_be_displayed() {
        ...
        Assert.assertTrue( prescriptionAction.isDeleteConfirmationPopupDisplayed(),
                "Delete confirmation popup not displayed");
    }

    @When("the user confirms deletion")
    public void the_user_confirms_deletion() {
        HelperClass.logger.info("Confirming deletion for IPD: {}",IPD_NUMBER);
    ...
    public void the_prescription_should_be_deleted_successfully() {
        ...
        Assert.assertTrue(prescriptionAction.isPrescriptionDeletedSuccessfully(),
